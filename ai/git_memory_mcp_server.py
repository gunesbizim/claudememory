#!/usr/bin/env python3
"""
git_memory_mcp_server.py

MCP server that exposes Git memory tools to Claude Code.
Run with:
    python ai/git_memory_mcp_server.py
...
REPO_PATH  = os.getenv("GIT_MEMORY_REPO_PATH", ".")
USER_ID    = os.getenv("GIT_MEMORY_USER_ID", "git_memory_system")
